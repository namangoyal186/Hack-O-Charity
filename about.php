...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="rjn/style.css">
</head>
            ...
            <div class="row flex-wrap justify-content-center justify-content-lg-between align-items-lg-center">
                <div class="col-12 col-lg-8 d-none d-md-flex flex-wrap justify-content-center justify-content-lg-start mb-3 mb-lg-0">
                    ...
                    <div class="header-bar-text">
                        <p>PHONE: <span>+91 9508800011</span></p>
                    </div><!-- .header-bar-text -->
                </div><!-- .col -->
            ...
            <div class="row">
                <div class="col-12 d-flex flex-wrap justify-content-between align-items-center">
                    <div class="site-branding d-flex align-items-center">
                        <a class="d-block" href="index.php" rel="home"><h1>Hack-O-Charity</h1><!-- <img class="d-block" src="images/logo.png" alt="logo"> --></a>
                    </div><!-- .site-branding -->
    ...
    <div class="welcome-wrap">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-6 order-2 order-lg-1">
                    <div class="welcome-content">
                        ...
                        <div class="entry-content mt-5">
                            <p align="justify">
                                <h5>
                                Our mission is to give a helping hand to all<br>
                                in need.We provide N.G.O's a platform to reach<br>
                                people.You can contribute to the scoietyby <br>
                                donating money, cloths and also by giving the<br> 
                                food leftovers after any function to the <br>
                                verified N.G.O.'s.You will not have to worry <br>
                                about your donation being used for welfare,<br> </h5>
                            </p>
                        </div><!-- .entry-content -->
                ...
                <div class="col-12 col-lg-6 order-1 order-lg-2">
                    <img src="http://www.sheppardshelpinghands.com/images/imagehands.jpg?crc=508046017"  alt="welcome">
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .container -->
    </div><!-- .home-page-icon-boxes -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 d-flex flex-wrap justify-content-between align-items-center">
                    ...
                    <a class="btn orange-border" href="https://www.payumoney.com/paybypayumoney/#/9019FC6CDD96CA5E75B0FF4F683DEA8B">Donate now</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="foot-about">
                            <h3><a class="foot-logo" href="#">Hack-O-Charity</h3>
                            <div class="charity-bottom">
                                <p align="justify">Charity brings to life again to those who are spiritually dead. He who has never denied himself for the sake of giving, has but glanced at the joys of charity. Charity is injurious unless it helps the recipient to become independent of it.</p>
                            </div>
                    ...
                    <div class="jkl">
                        <div class="foot-contact">
                            ...
                            <ul>
                                <li><i class="fa fa-phone"></i><span>+91 9508800011<br></span></li>
                                <li><i class="fa fa-envelope"></i><span>namangoyal983@gmail.com<br></span></li>
                                <li><i class="fa fa-map-marker"></i><span>T.I.E.T, 147001, Punjab, IND</span></li>
                            </ul>
                        </div><!-- .foot-contact -->
