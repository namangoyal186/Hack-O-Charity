            ...
            <div class="row flex-wrap justify-content-center justify-content-lg-between align-items-lg-center">
                <div class="col-12 col-lg-8 d-none d-md-flex flex-wrap justify-content-center justify-content-lg-start mb-3 mb-lg-0">
                    ...
                    <div class="header-bar-text">
                        <p>PHONE: <span>+91 9646947900</span></p>
                    </div><!-- .header-bar-text -->
                </div><!-- .col -->
            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="entry-content">
                        ...
                        <p class="justi"><h5>Love is not patronizing and charity isn't about pity, it is about love. Charity and love are the same -- with charity you give love, so don't just give money but reach out your hand instead.</h5></p>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="foot-about">
                            ...
                            <p class="footy">The best way to not feel hopeless is to get up and do something. Don’t wait for good things to happen to you. If you go out and make some good things happen, you will fill the world with hope, you will fill yourself with hope.</p>
                    ...
                    <div class="shifted-contacts">
                        <div class="foot-contact">
                            <h2 class="qwe">Contact</h2>
